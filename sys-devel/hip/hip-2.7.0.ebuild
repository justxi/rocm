...
SLOT="0/$(ver_cut 1-2)"
KEYWORDS="~amd64"
IUSE="debug +clang system-llvm-roc"
CMAKE_BUILD_TYPE=Release

DEPEND="dev-libs/rocm-comgr
	!clang? ( =sys-devel/hcc-${PV}* )
	clang? ( =sys-devel/llvm-roc-${PV}* )
"
RDEPEND="${DEPEND}"
...
src_configure() {
	...
	local mycmakeargs=(
		...
		-DHIP_PLATFORM=$(usex system-llvm-roc "clang" "hcc")
		-DHIP_COMPILER=$(usex system-llvm-roc "clang" "hcc")
