...
**Ebuilds for ROCm 4.1.0 are work in progress... Thats means creating PRs to Gentoo portage and Science overlay.**<br>

**Thanks to all contributors.**

The following tables show all ebuilds tested (2020-03-31) in this repository. <br>
...
|dev-util/rocm-clang-ocl| 4.1.0 | | (ok) | | science<br> :heavy_check_mark:<br> 4.0.0 |
