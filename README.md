...
Currently all ebuilds which depend on HIP will be updated to depend on "dev-util/hip" in Gentoo portage.
...
|dev-util/rocm-smi| 4.0.0 | Reports suitable informations. | (ok) | WIP |
